...
const Payment = () => {
  ...
  <div id="card-content">
    ...
    <h5>Username: <span>{localStorage.getItem('username')}</span></h5>
   
    <h5>Location: <span>{carDetails.location}</span></h5>
    <h5>Price per day: <span>${carDetails.price}</span></h5>
    <div className="dates-price">
      <h5 className="label">Booking Dates:</h5>
      <p>{startDate} to {endDate}</p>
    </div>
    {startDate && endDate && <h5>Total Price: <span>${totalPrice}</span></h5>}
